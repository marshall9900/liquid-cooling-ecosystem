...
function createSlide(p) {
  ...
  const items = [
    { label: "战略定位", text: "海悟定位:专业热管理零部件供应商->非OEM竞争对手(合作供应视角)->非系统集成商(组件为王)->双线独立:国内线+海外线 | 三大催化赛道:光通信+液冷+国产AI算力→韬(τ)定律:时间缩微替代几何缩微 国产芯片摆脱先进制程依赖" },
    { label: "2026-2027黄金窗口", text: "全球OTT CAPEX $6,000亿+(+88%) | NVL576 600KW/柜纯液冷 | TPU V8 1300W全浸没 | ASIC芯片全采液冷 | 800V HVDC架构→液冷协同 | 全产业链能力=准入门槛 | 率先OEM认证+头部PoC者胜出" },
