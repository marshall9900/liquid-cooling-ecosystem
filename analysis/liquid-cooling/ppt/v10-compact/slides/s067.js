...
function createSlide(p) {
  ...
  source(s, "竞争定位对标: sources/sec/oem/VRT/submissions_2026-05-09.json, sources/sec/oem/VRT/VRT-10-K_2026-02-13.md026-02-13.md → Vertiv全栈方案(电源+热管理+IT基础设施) | 国信证券 2026-04-14 → 服务器液冷供应商国产替代新机遇 | 海悟战略规划 → 专业组件供应商差异化定位:不做服务器/不做DC 专注组件供应 | 📐铁律⑩");
  badge(s, "87");
}
