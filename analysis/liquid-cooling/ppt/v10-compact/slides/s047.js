...
function createSlide(p) {
  ...
  h.insight(s, '竞争窗口明确:Manifold(P0)+国产GPU冷板(P0)+CDU差异化(P1) | 2026-2027黄金窗口 | 全产业链能力=准入门槛 刷新2026-05-30', Math.min(2.93, 4.4));
  h.source(s, 's066+s069合并: 液冷竞争格局全会审 国产冷板热阻0.042-0.048℃/W 海悟差异化窗口2026-2027 | 全产业链能力从加分项→准入门槛 刷新2026-05-30');
}
