...
function createSlide(p) {
  ...
  h.insight(s, '字节+阿里+腾讯=OTT液冷80% | P0攻字节(零供应商)+P1阿里/腾讯 | CDU/Manifold均不受GPU绑定', Math.min(3.5100000000000002, 4.4));
  h.source(s, 's018+s019+s020合并: 四大OTT AI CAPEX ¥6,500亿+(2026E) SAM=液冷采购×(CDU+Manifold+冷板可参与)~10-20%');
}
