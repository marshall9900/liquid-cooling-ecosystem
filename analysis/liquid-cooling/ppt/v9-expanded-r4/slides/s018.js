...
function createSlide(p) {
  ...
  takeaway(s, 'CDU/Manifold赛道≠GPU绑定 海悟可直投招标 字节=最大窗口 | Google TPU V8 1300W全浸没+Anthropic $36B融资信号 刷新2026-05-30', 4.78);
  source(s, 'sources/wechat/2026-05-07-ott-csp-gpu-capex-830b-usd.md → 四大OTT AI CAPEX ¥6,500亿+(2026E); sources/wechat/2026-05-07-bytedance-alibaba-idc-procurement-2026.md → 字节/阿里IDC招标规模及液冷要求; sources/wechat/2026-05-06-ali-ppu-chip-overview.md → 阿里芯片生态; Google云订单积压$4,600亿/TPU月Token 3200万亿(7x) | Anthropic+Apollo/黑石$360亿TPU融资 | 刷新2026-05-30');
  badge(s, '18');
}
