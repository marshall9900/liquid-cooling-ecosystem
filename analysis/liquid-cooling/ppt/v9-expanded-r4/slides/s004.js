...
function createSlide(pr) {
  ...
  insight(s, 'GPU从700W→2000W+ 仅3年时间 风冷物理极限600W已被全面突破');
  source(s, 'sources/wechat/2026-05-07-ott-csp-gpu-capex-830b-usd.md, sources/wechat/2026-05-06-super-node-insight.md → NVIDIA GPU路线图 H100→Rubin; NVIDIA官网 → GPU规格; sources/sec/oem/VRT/submissions_2026-05-09.json, sources/sec/gpu/NVDA/submissions_2026-05-09.json, sources/sec/gpu/NVDA/submissions_2026-05-09.json → SEC 10-K核实GPU出货; 推算:风冷极限≈600W(风量×温差×比热) Rubin 1500W+=2.5倍风冷极限→液冷唯一解 【估算】基于公开数据推算');
  badge(s, '04');
}
