...
function createSlide(pres) {
  ...
  ], { x: 0.5, y: 1.1, w: 9, colW: [2, 2, 2, 1.5], rowH: 0.32, border: { color: theme.secondary, pt: 0.5 } });
  
  s.addText('全球OTT AI Capex 2026E: ~$362B → 液冷采购额 $29-36B (8-10%)', { x: 0.5, y: 4.0, w: 9, h: 0.4, fontSize: 12, fontFace: 'Microsoft YaHei', color: theme.accent, bold: true });
  s.addText('源: SEC 10-Q MSFT/GOOG/AMZN/META (2026-04-30) + sources/wechat/2026-05-07-ott-csp-gpu-capex-830b-usd.md', { x: 0.5, y: 4.8, w: 9, h: 0.3, fontSize: 7, fontFace: 'Microsoft YaHei', color: theme.secondary });
