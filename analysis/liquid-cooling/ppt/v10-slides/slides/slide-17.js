...
function createSlide(pres) {
  ...
  const chain = [
    ['GPU 芯片厂家\n(定冷板标准)', 'NVIDIA: 选OEM+认证供应商\n昇腾: 灵衢互联 一年一代翻倍\nAtlas950→960→970(2028)\nAMD MI350P: PCIe冷板新形态', '海悟 → 争取NVIDIA认证\n昇腾线需华为认证体系\nPCIe冷板=新增量入口', theme.primary],
    ['↓', '', '', 'FFFFFF'],
    ['服务器 OEM\n(做适配采购)', 'H3C/浪潮/宁畅: NVIDIA适配\n超聚变: 华为体系\n华勤: ODM灵活\n⚠️ 供应链短缺1-2年(晶圆/芯片/光模块)', '海悟 → Manifold送样\n→ 冷板跟进 → CDU远期', theme.secondary],
    ['↓', '', '', 'FFFFFF'],
    ['OTT/IDC 运营方\n(自主决策CDU/Manifold)', '字节/阿里: CDU招标\n运营商DC: 自主采购\n海外: OCP认证通道\n🔥 冷却可靠性=新采购维度(AWS宕机)', '海悟 → 通过秦淮/数据港\n→ OCP认证 → 海外\n冗余CDU=差异化卖点', theme.accent],
  ];
